...
const botname = process.env.BOTNAME || 'MCZO JR';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'𝐌𝐂𝐙𝐎 ';
    const packname = process.env.STICKER_PACKNAME || '𝐉𝐫';
const dev = process.env.DEV || '255629695079'
...
"✠",
	"☬",
        "☫",	
"⭓𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐌𝐂𝐙𝐎-𝐉𝐑! 😬"
]
let { key } = await client.sendMessage(from, {text: '𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐌𝐂𝐙𝐎-𝐉𝐑 ! 😬...'})
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ MCZO-JR ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./classic.jpg'),
                                sourceUrl: 'https://wa.me/254742491666?text=ʜᴇʟʟᴏ+𝐤𝐢𝐧𝐠+Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
function _0x2de4() {
    const _0xca7309 = [
        ...
        'catch',
        'e\x20text.\x20Th',
        '\x20of\x20its developer 𝑪⃪𝒍⃪𝒂⃪𝒔⃪𝒔⃪𝒊⃪𝒄⃪',
        'is\x20AI\x20work',
        '1832596QZCVhJ',
        '\x20and\x20Googl',
        'AgaVJ',
...
client.sendMessage(from,{image:krt.result,caption:"Done by Classic"}, {quoted:m})
}
break;	
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝐌𝐂𝐙𝐎 𝐉𝐑'); 
} catch (errr) { 
 ...
 client.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/72615a4dd05a7f00b8228.jpg` }, caption: 
`👋🏻 Hi *${pushname}*,You can deploy 𝐌𝐂𝐙𝐎 𝐉𝐑 using the GitHub link below🗿\n\nFork and give us a star✨.\n\n https://github.com/MczoJr/Mczo-Jr\n\nEnjoy and have fun with the bot🗿...\n\nUse the link below to pair 𝐌𝐂𝐙𝐎 𝐉𝐑 without scanning any qr code\n\n [https://replit.com/@darkintent120/Pairing-drex9]\n\nMade on Earth by 𝐌𝐂𝐙𝐎 𝐉𝐑⃪` });
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`𝐌𝐂𝐙𝐎.𝐉𝐑 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛 ${runtime(process.uptime())}`) 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/7a17963a503bdf71771db.mp4' }, caption: `𝐇𝐞𝐥𝐥𝐨 *${m.pushName}*, 𝐁𝐥𝐚𝐜𝐤_𝐌𝐚𝐦𝐛𝐚 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐚𝐥𝐢𝐯𝐞 𝐬𝐢𝐧𝐜𝐞 *${runtime(process.uptime())}*,\n\n✠𝐓𝐲𝐩𝐞 ${prefix}𝐦𝐞𝐧𝐮 𝐭𝐨 𝐚𝐜𝐜𝐞𝐬𝐬 𝐦𝐲 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐥𝐢𝐬𝐭.\n✠𝐓𝐲𝐩𝐞 ${prefix}𝐫𝐞𝐩𝐨 𝐭𝐨 𝐠𝐞𝐭 𝐦𝐲 𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐨𝐝𝐞.\n✠𝐓𝐲𝐩𝐞 ${prefix}𝐨𝐰𝐧𝐞𝐫 𝐭𝐨 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 𝐦𝐲 𝐜𝐫𝐞𝐚𝐭𝐨𝐫.\n\n☬𝐄𝐧𝐣𝐨𝐲 𝐚𝐧𝐝 𝐇𝐚𝐯𝐞 𝐟𝐮𝐧 𝐰𝐢𝐭𝐡 𝐭𝐡𝐞 𝐛𝐨𝐭.\n✘𝐌𝐚𝐝𝐞 [𝐂𝐥𝐨𝐧𝐞𝐝] 𝐛𝐲 𝑪⃪𝒍⃪𝒂⃪𝒔⃪𝒔⃪𝒊⃪𝒄⃪`,fileLength: "9999999999898989899999999" }, { quoted: m });
 }
break;
case 'apk': {
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 𝐌𝐂𝐙𝐎 𝐉𝐑☄️*`}, { quoted: m }) 
...
case "movie": 
 ...
 break;
      ...
      case "mczo": case "owner": case "jr": 
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/3b1d1da9130d4d84a7adc.mp4' }, caption: `☬𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐦𝐲 𝐨𝐰𝐧 𝐜𝐫𝐞𝐚𝐭𝐨𝐫☬, +255629695079 ☫` }, {quoted: m}); 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ 𝐌𝐂𝐙𝐎 𝐉𝐓 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/654cb9cfe880d6fbb4529.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
 ...
 break;
        ...
        case "gpt": case "jr": 
            ...
            if (!text) return reply("Hello am 𝐌𝐂𝐙𝐎.𝐉𝐑 an Ai developed by 𝑪⃪𝒍⃪𝒂⃪𝒔⃪𝒔⃪𝒊⃪𝒄⃪, how can I help you today?");
...
async function handleGPTMessage(text, m) {
  if (!text) return m.reply("Hello am 𝐌𝐀𝐌𝐁𝐀 an Ai developed by 𝑪⃪𝒍⃪𝒂⃪𝒔⃪𝒔⃪𝒊⃪𝒄⃪⸼, how can I help you today?");
