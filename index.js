...
let botname = process.env.BOTNAME || '𝐌𝐂𝐙𝐎.𝐉𝐑';

const owner = process.env.DEV || '255629695079'; // This will send a notification once the bot reconnects
const {
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, 𝐌𝐂𝐙𝐎-𝐉𝐑 has successfully connected to this server", "green"));
      console.log(color("Follow me on Instagram as @ano_nymous_sam", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `𝐌𝐂𝐙𝐎-𝐉𝐑 𝐡𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝. . .\n\n𝐌𝐂𝐙𝐎-𝐉𝐑\n\nHave fun with the bot☬` });
    }
